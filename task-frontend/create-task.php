<?php 
  ...
  if(isset($_POST['createTask'])) {
    ...
    $fetchAPITask->createTask($_POST['task'], $_POST['priority'], $_POST['tag'], $_POST['description']);

    $fetchCreateTask = $fetchAPITask->createTask;
      ...
      <div class="container py-5 w-75">
       ...
       <form class="row g-3" action="#" method="POST">
          <div class="col-md-12">
            ...
            <input type="text" class="form-control" id="inputEmail4" name="task">
          </div>
          <div class="col-md-4">
          ...
          <div class="col-12">
            <button type="submit" name="createTask" class="btn btn-primary">Create Task</button>
          </div>
        </form>
      </div>
    </main>
